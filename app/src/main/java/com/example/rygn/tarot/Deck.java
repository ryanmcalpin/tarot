...
public class Deck {
    ...
    public List<Card> getCards() {
        cards.add(new Card("The Fool", R.drawable.maj_00, ""));
        cards.add(new Card("The Magician", R.drawable.maj_01, ""));
        cards.add(new Card("The High Priestess", R.drawable.maj_02, ""));
        cards.add(new Card("The Empress", R.drawable.maj_03, ""));
        ...
        cards.add(new Card("Two of Cups", R.drawable.min_c_02, ""));
